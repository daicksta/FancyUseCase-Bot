...
%
	...
	\section{Auslegung der Schulter}\label{sec:auslegung}
		...
		Weiter wird von jeweiligen Längen für Ober- und Unterarm von \SI{0,35}{\metre} ausgegangen .\par
	...
	\section{Auslegung der künstlichen Muskeln}
		...
		Dazu wurde in eigener Recherche ermittelt, dass die maximalen Geschwindigkeiten \(v_{Kugel}\) einer Billiradkugel bei ungefähr \SI{40}{\kilo\metre\per\hour}, also \SI{11,1}{\metre\per\second}, liegt. 
