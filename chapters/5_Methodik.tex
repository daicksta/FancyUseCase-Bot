...
\chapter{Methodik}
	\section{Funktionsgliederung/-Struktur}
		...
		Zum Zwecke der Reduktion des Komplexitätsgrades des Gesamtsystems wird sich für das Erstellen eines Funktionsbaumes entschieden. Diese Methode wird bewusst gewählt, um eine einfache Nachvollziehbarkeit und Lesbarkeit zu verschaffen.\\
		...
		\subsection{Funktionsbaum}
			Zunächst werden die allgemeinen Funktionen in Kategorien unterteilt, um eine Übersicht zu verschaffen. Diese sind in einem Funktionsbaum (siehe \cref{fig:funktionsbaum}) zu sehen.
			\begin{figure}[h]
				\centering
		...
		\subsection{Morphologische Kästen}
			...
			In \cref{fig:morphologische-kasten-teilprobleme} werden als allererstes die Teilprobleme aufgelistet, wobei die Baugruppen Schulter, Ellbogen und Handgelenk in \cref{fig:morphologische-kasten-schulter}, \cref{fig:morphologische-kasten-ellbogen} und \cref{fig:morphologische-kasten-handgelenk} eigene morphologische Kästen bekommen, da sie noch einige Unterfunktionen enthalten, für die auch mehrere Lösungsmöglichkeiten infrage kommen. Dasselbige gilt auch für die Teilprobleme des Feedback-Systems in \cref{fig:morphologische-kasten-feedback-system}.
	...
	\section{Begründung der Lösungsauswahl}\label{Begründung Loesungsauswahl}
