	...
	\section{Funktionsgliederung/-Struktur}
		...
		\subsection{Morphologische Kästen}
			...
			\begin{table}[h]
				...
				\includegraphics[width=\textwidth]{Abb/Morphologischer_Kasten_Teilprobleme}\label{tab:morphologische-kasten-teilprobleme}
			\end{table}
%
			\begin{table}[h]
				\centering
				\caption[Morphologischer Kasten der Schulter]{Morphologischer Kasten der Schulter.}
				\includegraphics[width=\textwidth]{Abb/Morphologischer_Kasten_Schulter}\label{tab:morphologische-kasten-schulter}
			\end{table}
%
			\begin{table}[h]
				\centering
				\caption[Morphologischer Kasten des Ellbogens]{Morphologischer Kasten des Ellbogens.}
				\includegraphics[width=\textwidth]{Abb/Morphologischer_Kasten_Ellbogen}\label{tab:morphologische-kasten-ellbogen}
			\end{table}
%
			\begin{table}[h]
				\centering
				\caption[Morphologischer Kasten des Handgelenks]{Morphologischer Kasten des Handgelenks.}
				\includegraphics[width=\textwidth]{Abb/Morphologischer_Kasten_Handgelenk}\label{tab:morphologische-kasten-handgelenk}
			\end{table}
%
			\begin{table}[h]
				\centering
				\caption[Morphologischer Kasten des Feedback-Systems]{Morphologischer Kasten des Feedback-Systems.}
				\includegraphics[width=\textwidth]{Abb/Morphologischer_Kasten_Feedback-System}\label{tab:morphologische-kasten-feedback-system}
			\end{table}
